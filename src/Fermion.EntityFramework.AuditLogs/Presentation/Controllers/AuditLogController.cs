...
public class AuditLogController(IAuditLogAppService auditLogAppService) : ControllerBase
{
    ...
    public async Task<ActionResult<AuditLogResponseDto>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<PageableResponseDto<AuditLogResponseDto>>> GetPageableAndFilterAsync(
        [FromQuery] GetListAuditLogRequestDto request,
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<List<EntityPropertyChangeResponseDto>>> GetEntityPropertyChangesAsync(
        Guid auditLogId,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<EntityChangeSummaryResponseDto>> GetEntityChangeSummaryAsync(
        [FromQuery] GetEntityChangeSummaryRequestDto request,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<UserActivityAnalysisResponseDto>> GetUserActivityAnalysisAsync(
        [FromQuery] UserActivityAnalysisRequestDto request,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<MostModifiedEntitiesResponseDto>> GetMostModifiedEntitiesAsync(
        [FromQuery] MostModifiedEntitiesRequestDto request,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<EntityChangesTrendResponseDto>> AnalyzeEntityChangesTrendAsync(
        [FromQuery] EntityChangesTrendRequestDto request,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<UserChangeBehaviorResponseDto>> AnalyzeUserChangeBehaviorAsync(
        [FromQuery] UserChangeBehaviorRequestDto request,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ActionResult<int>> CleanupOldAuditLogsAsync(
        [FromQuery] DateTime olderThan,
        CancellationToken cancellationToken = default)
    {
        var deletedCount = await auditLogAppService.CleanupOldAuditLogsAsync(olderThan, cancellationToken);

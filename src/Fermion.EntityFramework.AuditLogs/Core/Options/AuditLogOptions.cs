...
namespace Fermion.EntityFramework.AuditLogs.Core.Options;
...
public class AuditLogOptions
{
    ...
    /// <summary>
    /// Specifies whether the AuditLog API endpoints should be exposed automatically
    /// </summary>
    public bool EnableApiEndpoints { get; set; } = true;

    /// <summary>
    /// Base route for AuditLog API endpoints
    /// </summary>
    public string ApiRoute { get; set; } = "api/audit-logs";

    /// <summary>
    /// Authorization settings for AuditLog endpoints
    /// </summary>
